...
const Map = React.createClass({
  ...
  render() {
    ...
    "box-shadow": "0 0 17px 2px black" };
        var enemy = { background: "blue", color: "blue" , "box-shadow": "0px 0px 4px 0px black;",position:"relative"};
        var player = { background: "red", color: "red",
    "box-shadow": "0px 0px 4px 0px black;",position:"absolute" };
    ...
    "box-shadow": "0px 0px 4px 0px black;",position:"relative"}
        var boss = { background: "black", color: "black",border: "1px solid white",
     "box-shadow": "0px 0px 4px 0px black;",position:"relative" }
        ...
        if (map[i][j] == 0) {
          ...
          dummy.push(<td style={x}></td>);
        } else if (map[i][j] == "p") {
          dummy.push(<td style={player}></td>);
        } else if (map[i][j] == "e") {
          var x = enemy;
                                 if (fov.includes(val)) {
                                  x.visibility = "visible";
...
//           var x = boss;
    ...
    return (
      <div>
        ...
        <div  class="container" id="gameArea" tabIndex="0" >
       <div id="info">
